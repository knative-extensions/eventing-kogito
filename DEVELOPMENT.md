...
`eventing-kogito`. Also take a look at:
...
1. [`go`](https://golang.org/doc/install): The language Knative `eventing-kogito`
   is built in
...
cd kogito-source
git remote add upstream https://github.com/knative/eventing-kogito.git

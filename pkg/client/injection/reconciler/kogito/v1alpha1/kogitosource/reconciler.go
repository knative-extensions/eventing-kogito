...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.KogitoSource, desiredFinalizers sets.String) (*v1alpha1.KogitoSource, error) {
	// Don't modify the informers copy.

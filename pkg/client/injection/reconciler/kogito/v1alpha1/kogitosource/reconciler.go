...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.KogitoSource, desired *v1alpha1.KogitoSource) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.KogitoSource, desiredFinalizers sets.Set[string]) (*v1alpha1.KogitoSource, error) {
	// Don't modify the informers copy.

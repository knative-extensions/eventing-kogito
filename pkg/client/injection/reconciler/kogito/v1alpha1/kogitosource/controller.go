...
import (
	...
	versionedscheme "knative.dev/eventing-kogito/pkg/client/clientset/versioned/scheme"
	client "knative.dev/eventing-kogito/pkg/client/injection/client"
	kogitosource "knative.dev/eventing-kogito/pkg/client/injection/informers/kogito/v1alpha1/kogitosource"
...
const (
	defaultControllerAgentName = "kogitosource-controller"
	defaultFinalizerName       = "kogitosources.kogito.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	kogitosourceInformer := kogitosource.Get(ctx)

	lister := kogitosourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "kogito.knative.dev.KogitoSource"),
	)

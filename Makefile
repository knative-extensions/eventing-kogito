...
# acme.org/acme-operator-bundle:$VERSION and acme.org/acme-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/kiegroup/kogito-source
...
bundle: kustomize ## Generate bundle manifests and metadata, then validate generated files.
	...
	mv kogito.yaml tmp/
	## Additional permissions required by the addressable resolver
